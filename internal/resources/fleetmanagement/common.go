...
func withClientForResource(req resource.ConfigureRequest, resp *resource.ConfigureResponse) (*fleetmanagementapi.Client, error) {
	...
	if client.FleetManagementClient == nil || client.FleetManagementClient.CollectorServiceClient == nil {
		resp.Diagnostics.AddError(
		...
		return nil, fmt.Errorf("the Fleet Management Collector Service Client is nil")
	}
